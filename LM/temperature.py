"""
From https://github.com/google/flax/blob/main/examples/lm1b/temperature_sampler.py
"""
...
def temperature_sample(
    prompt_inputs: jax.Array,
    init_cache: jax.Array,
    ...
    def sampling_loop_body_fn(state):
        ...
        next_token_or_endpad = next_token[..., jnp.newaxis] * ~ended
