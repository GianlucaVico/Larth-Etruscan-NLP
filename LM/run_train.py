...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        prog="LarthLM training script", description="IthacaLike training script"
    )
    parser.add_argument(
    ...
    from LMLarth import LarthLMConfig

    model_config = LarthLMConfig(**parse_config(args.model_config))
